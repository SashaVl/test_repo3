...
foreach ($invoices as $i => $invoice) {
    ...
    $array = array(
        ...
        'idCodice'              =>  vars::ID_CODICE,                         //налоговый кодекс (юридична адреса продавця)
        'progressivoInvio'      =>  vars::PROGRESSIVO_INVIO,                 //Тип документа
        'FormatoTrasmissione'   =>  vars::FORMATO_TRANSMISSIONE,             //Критерии для продвижения по службе: принимает фиксированное значение
        'CodiceDestinatario'    =>  vars::CODICE_DESTINATARIO,               //код документа из 6 символов
